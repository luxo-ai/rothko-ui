...
import { Flex, classes, scopedClasses } from '@rothko-ui/system';
  ...
  return (
    <>
      <div
        ...
        style={{ ...tabsStyle, ...styleProp }}
      >
        <Flex as="ul" className={styles['tab-list']} aria-controls={ariaControls} role="tablist">
          {controller.keys.map((tabKey, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className={styles['tab__item']}>{title}</div>
