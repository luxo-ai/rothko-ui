...
const LAYOUT: DeepRequired<LayoutConfig> = {
  ...
  fontSize: {
    ...
    bodyLarge: layout.FONT_SIZE_BODY_LARGE,
    bodyXLarge: layout.FONT_SIZE_BODY_X_LARGE,
  ...
  lineHeight: {
    ...
    bodyLarge: layout.LINE_HEIGHT_BODY_LARGE,
    bodyXLarge: layout.LINE_HEIGHT_BODY_X_LARGE,
