...
export const RADIO_BACKGROUND_FOCUS = '#3c54ff';
...
export const SWITCH_BORDER = '#d9d9d9';
export const SWITCH_BACKGROUND = '#dee7f5';
export const SWITCH_BACKGROUND_FOCUS = '#41ff69';
export const SWITCH_HANDLE_BACKGROUND = '#fff';
