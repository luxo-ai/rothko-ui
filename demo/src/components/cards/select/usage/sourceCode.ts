...
const App = () => {
  ...
  return (
    <Select clearable value={selected} onChange={v => setSelected(v)} options={DROPDOWN_OPTIONS} />
  );
};
...
const App = () => {
  ...
  return (
    <Select disabled value={selected} onChange={v => setSelected(v)} options={DROPDOWN_OPTIONS} />
  );
};
